...
import telecomNetworkHero from '@/assets/telecom-network-hero.jpg';
...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(34, 40, 49, 0.8), rgba(34, 40, 49, 0.8)), url(${telecomNetworkHero})`,
